...
@ResponseTemplatePath(path = "api/github/repos/_list/rs.json")
@SuccessfulHttpStatus(status = HttpResponseStatusType.OK_200)
public class GetGithubUserReposMethod extends AbstractApiMethodV2 {

    public GetGithubUserReposMethod(String username) {
